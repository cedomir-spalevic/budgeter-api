...
import { BudgetTypeValue, PublicBudgetIncome, PublicBudgetPayment } from "models/schemas/budget";
import UserBudgetCachingStrategy from "services/internal/caching/budgets";
import BudgeterMongoClient from "services/external/mongodb/client";
import { getBudgetIncomes, getBudgetPayments } from "services/internal/budgets/determine";
import { getBudgetIncomeQuery, getBudgetPaymentQuery } from "services/internal/budgets/query";
...
export const getIncomes = async (
   ...
   const cachingStrategy = new UserBudgetCachingStrategy<PublicIncome>(BudgetTypeValue.Income);
...
export const getPayments = async (
   ...
   const { userId } = context;
   const cachingStrategy = new UserBudgetCachingStrategy<PublicPayment>(BudgetTypeValue.Payment);
