...
export const validate = (request: Record<string, unknown>): Partial<User> => {
   ...
   if(request["notificationPreferences"]) {
      ...
      notificationPreferences = {
         incomeNotifications: notificationPreferencesInput["incomeNotifications"] as boolean ?? undefined,
         paymentNotifications: notificationPreferencesInput["paymentNotifications"] as boolean ?? undefined
      }
   }
   return {
